...
public class CSharpscaling : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            fingersOnScreen = ProcessTouch(fingersOnScreen, touch);
        }
    }

    private int ProcessTouch(int fingersOnScreen, Touch touch)
    {
        ...
        {
            GetScaleFactor(touch);
        }

        return fingersOnScreen;
    }

    private void GetScaleFactor(Touch touch)
    {
